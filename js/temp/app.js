(function() {
  var MouseAndTouch, createBox, createCircle, createDOMObjects, downHandler, drawDOMObjects, getBodyAtMouse, getBodyCB, getElementPosition, init, moveHandler, upHandler, update, updateMouseDrag;
