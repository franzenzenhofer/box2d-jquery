...
i.closePath();i.stroke()}})();var i;for(i=0;i<Box2D.postDefs.length;++i)Box2D.postDefs[i]();delete Box2D.postDefs;(function(t){t.fn.getStyleObject=function(){var t=this.get(0);var i;var e={};if(window.getComputedStyle){var o=function(t,i){return i.toUpperCase()};i=window.getComputedStyle(t,null);for(var n=0;n<i.length;n++){var s=i[n];var r=s.replace(/\-([a-z])/g,o);var a=i.getPropertyValue(s);e[r]=a}return e}if(t.currentStyle){i=t.currentStyle;for(var s in i){e[s]=i[s]}return e}return this.css()}})(jQuery);(function(t){isString=function(t){return toString.call(t)=="[object String]"};t.fn.bodysnatch=function(){var i=this;return i.each(function(e,o){var n=t(this);var s=n.clone();w=n.width();h=n.height();if(w&&h){if(window.getComputedStyle&&window.getComputedStyle.cssText){s.attr("style",window.getComputedStyle(n[0]).cssText)}else{s.css(n.getStyleObject())}s.css({position:"absolute",top:n.offset().top,left:n.offset().left,width:n.width(),height:n.height(),margin:0});s.addClass("perfect")}else{s.css({position:"absolute",top:n.offset().top,left:n.offset().left,margin:0});s.addClass("imperfect")}if(n[0].id){n[0].id=n[0].id+"_snatched"}n.addClass("snatched");s.addClass("bodysnatcher");n.css("visibility","hidden");if(n[0].pause){n[0].pause();n[0].src=""}i[e]=s[0];t("body").append(s)})}})(jQuery);(function(){var t=0;var i=["ms","moz","webkit","o"];for(var e=0;e<i.length&&!window.requestAnimationFrame;++e){window.requestAnimationFrame=window[i[e]+"RequestAnimationFrame"];window.cancelAnimationFrame=window[i[e]+"CancelAnimationFrame"]||window[i[e]+"CancelRequestAnimationFrame"]}if(!window.requestAnimationFrame)window.requestAnimationFrame=function(i,e){var o=(new Date).getTime();var n=Math.max(0,16-(o-t));var s=window.setTimeout(function(){i(o+n)},n);t=o+n;return s};if(!window.cancelAnimationFrame)window.cancelAnimationFrame=function(t){clearTimeout(t)}})();(function(){var t,i,e,o,n,s,r,a,l,m,c,h,_,p,u,y,x,f,d,b,B,v,D,g,C,w,A,S,V,M,I,G,L,J,F,P,R,T,k,z,N,E,j,q,U,O,K,W,X,Z;b=Box2D.Common.Math.b2Vec2;l=Box2D.Collision.b2AABB;c=Box2D.Dynamics.b2BodyDef;m=Box2D.Dynamics.b2Body;u=Box2D.Dynamics.b2FixtureDef;p=Box2D.Dynamics.b2Fixture;B=Box2D.Dynamics.b2World;y=Box2D.Collision.Shapes.b2MassData;f=Box2D.Collision.Shapes.b2PolygonShape;h=Box2D.Collision.Shapes.b2CircleShape;_=Box2D.Dynamics.b2DebugDraw;d=Box2D.Dynamics.Joints.b2RevoluteJointDef;x=Box2D.Dynamics.Joints.b2MouseJointDef;t=jQuery;F={"-webkit-transform":"translateZ(0)","-moz-transform":"translateZ(0)","-o-transform":"translateZ(0)",transform:"translateZ(0)"};a=false;e=false;W={};X=0;Z=0;r=30;i=Math.PI/180;s=180/Math.PI;n=Math.PI*2;R={};V=false;C=1.5;w=.3;A=.4;S="box";N=0;E=0;z=void 0;T=false;q=void 0;k=void 0;o=function(t,i,e,o){var n,s,r,a,l,m,c,h,_,p,u;n=t;N=void 0;E=void 0;c=void 0;h=void 0;s=false;a=function(t){u(t);return o(N,E)};u=function(t){var i;t.preventDefault();i=t.originalEvent;if(i&&i.touches&&i.touches.length===1){i.preventDefault();N=i.touches[0].pageX;return E=i.touches[0].pageY}else{N=t.pageX;return E=t.pageY}};l=function(t){n.addEventListener("mousedown",r,true);n.removeEventListener("mousemove",a,true);s=false;u(t);return e(N,E)};p=function(t){n.addEventListener("touchstart",_,true);n.removeEventListener("touchmove",a,true);s=false;u(t);return e(N,E)};r=function(t){n.removeEventListener("mousedown",r,true);n.addEventListener("mouseup",l,true);n.addEventListener("mousemove",a,true);s=true;u(t);return i(N,E)};_=function(t){n.removeEventListener("touchstart",_,true);n.addEventListener("touchend",p,true);n.addEventListener("touchmove",a,true);s=true;u(t);return i(N,E)};n.addEventListener("mousedown",r,true);n.addEventListener("touchstart",_,true);m={};m.mouseX=function(){return N};m.mouseY=function(){return E};m.isDown=function(){return s};return m};M=function(t,i){T=true;return j(t,i)};U=function(t,i){T=false;N=null;return E=null};j=function(t,i){N=t/30;return E=i/30};G=function(){var t;z=new b(N,E);t=new l;t.lowerBound.Set(N-.001,E-.001);t.upperBound.Set(N+.001,E+.001);q=null;W.QueryAABB(L,t);return q};L=function(t){if(t.GetBody().GetType()!==m.b2_staticBody){if(t.GetShape().TestPoint(t.GetBody().GetTransform(),z)){q=t.GetBody();return false}}return true};J=function(t){var i,e,o,n;i=t;e="";o=0;n=0;while(typeof i==="object"&&typeof i.tagName!=="undefined"){n+=i.offsetTop;o+=i.offsetLeft;e=i.tagName.toUpperCase();if(e==="BODY"){i=0}if(typeof i==="object"?typeof i.offsetParent==="object":void 0){i=i.offsetParent}}return{x:o,y:n}};K=function(){var t,i;if(T&&!k){t=G();if(t){i=new x;i.bodyA=W.GetGroundBody();i.bodyB=t;i.target.Set(N,E);i.collideConnected=true;i.maxForce=300*t.GetMass();k=W.CreateJoint(i);t.SetAwake(true)}}if(k){if(T){return k.SetTarget(new b(N,E))}else{W.DestroyJoint(k);return k=null}}};g=function(i,e,o,n,s,r){if(e==null){e=S}if(o==null){o=V}if(n==null){n=C}if(s==null){s=A}if(r==null){r=w}return t(i).each(function(i,a){var l,m,c,h,_,p,u,y,x,f,d,b,B,C,w,A;m=t(a);_=m.width();h=m.height();if(!(_&&h)){if(m.attr("src")){if(typeof console!=="undefined"&&console!==null){console.log("box2d-jquery ERROR: an element withour width or height, will lead to strangeness!")}m.on("load",function(){return g(this,e,o,n,s,r)})}return true}c=t(a).position();C=_/2;p=h/2;w=c.left+C;A=c.top+p;f=m.attr("box2d-shape")?m.attr("box2d-shape"):e;u=parseFloat(m.attr("box2d-density")?m.attr("box2d-density"):n);x=parseFloat(m.attr("box2d-restitution")?m.attr("box2d-restitution"):s);y=parseFloat(m.attr("box2d-friction")?m.attr("box2d-friction"):r);if(m.attr("box2d-static")==="true"){d=true}else if(m.attr("box2d-static")==="false"){d=false}else{d=o}if(f&&f!=="circle"){l=v(w,A,C,p,d,u,x,y)}else{B=C>p?C:p;l=D(w,A,B,d,u,x,y)}l.m_userData={domObj:m,width:C,height:p};b="50% 50% 0";m.css({"-webkit-transform-origin":b,"-moz-transform-origin":b,"-ms-transform-origin":b,"-o-transform-origin":b,"transform-origin":b});return true})};v=function(t,i,e,o,n,s,a,l){var h,_;if(n==null){n=V}if(s==null){s=C}if(a==null){a=A}if(l==null){l=w}h=new c;h.type=n?m.b2_staticBody:m.b2_dynamicBody;h.position.x=t/r;h.position.y=i/r;_=new u;_.density=s;_.friction=l;_.restitution=a;_.shape=new f;_.shape.SetAsBox(e/r,o/r);return W.CreateBody(h).CreateFixture(_)};D=function(t,i,e,o,n,s,a){var l,_;if(o==null){o=V}if(n==null){n=C}if(s==null){s=A}if(a==null){a=w}l=new c;l.type=o?m.b2_staticBody:m.b2_dynamicBody;l.position.x=t/r;l.position.y=i/r;_=new u;_.density=n;_.friction=a;_.restitution=s;_.shape=new h(e/r);return W.CreateBody(l).CreateFixture(_)};I=function(){var t,i,e,o,a,l,m,c,h;o=0;t=W.m_bodyList;h=[];while(t){e=t.m_fixtureList;while(e){if(e.m_userData){m=Math.floor(e.m_body.m_xf.position.x*r-e.m_userData.width);c=Math.floor(e.m_body.m_xf.position.y*r-e.m_userData.height);a=Math.round((e.m_body.m_sweep.a+n)%n*s*100)/100;l="rotate("+a+"deg)";i={"-webkit-transform":l,"-moz-transform":l,"-ms-transform":l,"-o-transform":l,transform:l,left:m+"px",top:c+"px"};e.m_userData.domObj.css(i)}e=e.m_next}h.push(t=t.m_next)}return h};O=function(){K();W.Step(2/60,8,3);I();if(e){W.DrawDebugData()}W.ClearForces();return window.setTimeout(O,1e3/30)};P=function(i,n,s,l){var m,c,h,p,u;if(n==null){n=C}if(s==null){s=A}if(l==null){l=w}a=true;W=new B(new b(X,Z),true);u=t(window).width();h=t(window).height();v(0,-1,t(window).width(),1,true,n,s,l);v(t(window).width()+1,0,1,t(window.document).height(),true,n,s,l);v(-1,0,1,t(window.document).height(),true,n,s,l);v(0,t(window.document).height()+1,t(window).width(),1,true,n,s,l);p=o(document,M,U,j);if(e){c=new _;m=t("<canvas></canvas>");c.SetSprite(m[0].getContext("2d"));c.SetDrawScale(r);c.SetFillAlpha(.3);c.SetLineThickness(1);c.SetFlags(_.e_shapeBit|_.e_jointBit);m.css("position","absolute");m.css("top",0);m.css("left",0);m.css("border","1px solid green");m.attr("width",t(window).width());m.attr("height",t(document).height());W.SetDebugDraw(c);t("body").append(m)}return O()};t.fn.extend({box2d:function(i){var o,n,s,r,l,m,c,h,_;c=t.fn.box2d;l=t.extend({},c.default_options,i);X=l["x-velocity"];Z=l["y-velocity"];s=l["density"];m=l["restitution"];r=l["friction"];h=l["shape"];_=l["static"];n=l["debug"];if(a===false){if(n===true){e=true}P(this,s,m,r)}o=this.bodysnatch();g(o,h,_,s,m,r);return t(o)}});t.extend(t.fn.physics,{default_options:{"x-velocity":0,"y-velocity":0,density:C,restitution:A,friction:w,"static":V,shape:S,debug:e}})}).call(this);